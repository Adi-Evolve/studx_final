    ...
    if (body.type === 'room') {
      try {
        ...
        const roomData = {
          ...
          furnished_status: body.furnished_status || null,
          area_sqft: body.area_sqft || null,
          has_balcony: body.has_balcony === 'true' || body.has_balcony === true || false,
          has_parking: body.has_parking === 'true' || body.has_parking === true || false,
        };

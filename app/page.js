    ...
    <section className="mb-16">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
        <Link href="/category/Laptop" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">💻</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Laptops</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Textbook" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">📚</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Textbooks</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Electronics" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">🔌</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Electronics</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Bike" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">🚲</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Bikes</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Notes" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">📝</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Notes</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Rooms" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">🏠</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Rooms</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Furniture" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">🪑</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Furniture</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Dorm" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">🎒</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Dorm Items</h3>
          </div>
        </Link>
        ...
        <Link href="/category/Other" className="group">
          <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition-transform duration-300">📦</div>
            <h3 className="font-semibold text-gray-800 text-sm md:text-base">Other</h3>
          </div>
        </Link>
      </div>
    </section>
    ...
    <section className="mb-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
        <div className="text-center">
          ...
          <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-1 md:mb-2">1. Sign Up</h3>
        ...
        <div className="text-center">
          ...
          <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-1 md:mb-2">2. List or Browse</h3>
          <p className="text-sm md:text-base text-gray-600">
        ...
        <div className="text-center">
          ...
          <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-1 md:mb-2">3. Connect & Deal</h3>
          <p className="text-sm md:text-base text-gray-600">
      ...
      <div className="text-center mt-6 md:mt-12">
        <Link
          href="/signup"
          className="bg-blue-600 text-white px-6 md:px-8 py-2 md:py-3 rounded-lg font-bold text-sm md:text-base hover:bg-blue-700 transition-colors inline-flex items-center"
        >
          Get Started Now

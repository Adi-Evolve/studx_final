...
export default function WishlistPage() {
    ...
    if (!user) {
        return <div className="text-center py-10">Please log in to see your wishlist.</div>;
    }
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            {wishlistItems.length > 0 ? (
                ...
                <p className="text-center text-gray-500">Your wishlist is empty. Start adding items!</p>
            )}
        </div>
    );
}

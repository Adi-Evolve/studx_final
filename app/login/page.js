...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-900 flex transition-colors duration-300">
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 dark:bg-gray-800 relative overflow-hidden transition-colors duration-300">
        <div className="flex flex-col justify-center items-center text-center p-12 text-white">
          <div className="w-20 h-20 bg-emerald-600 dark:bg-emerald-500 rounded-3xl flex items-center justify-center shadow-2xl mb-8">
            <span className="text-2xl font-black text-white">SX</span>
          </div>
          <h1 className="text-5xl font-black mb-6 text-white">StudX</h1>
          <h2 className="text-3xl font-bold mb-8 leading-tight text-slate-200 dark:text-gray-200">
            Welcome Back to Your
            <br />
            <span className="text-emerald-400 dark:text-emerald-300">Student Marketplace</span>
          </h2>
          <p className="text-xl text-slate-300 dark:text-gray-300 leading-relaxed max-w-md">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="lg:hidden text-center mb-8">
            <div className="w-16 h-16 bg-emerald-600 dark:bg-emerald-500 rounded-2xl flex items-center justify-center shadow-xl mx-auto mb-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-slate-200 dark:border-gray-700 transition-colors duration-300">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Welcome Back</h2>
              <p className="text-slate-600 dark:text-gray-400">Sign in to your StudX account</p>
            </div>
            {message && (
            ...
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors duration-300"
                    required
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 dark:text-gray-500 hover:text-slate-600 dark:hover:text-gray-300 transition-colors duration-300"
                  >
                    {showPassword ? "🙈" : "👁️"}
                  </button>
                </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-4 px-4 border border-transparent text-lg font-bold rounded-xl text-white bg-emerald-600 dark:bg-emerald-500 hover:bg-emerald-700 dark:hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 dark:focus:ring-offset-gray-800 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {isLoading ? (
              ...
              <button
                ...
                className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-slate-300 dark:border-gray-600 rounded-xl text-slate-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-slate-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 dark:focus:ring-offset-gray-800 transition-all duration-200 font-medium"
              >

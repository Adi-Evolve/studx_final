      ...
      <div>
        <div className="container mx-auto px-4 py-12">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-gray-700 mb-8">
            <h1 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Refund Policy</h1>
            <p className="text-slate-600 dark:text-gray-300 text-lg mb-6">
              We strive to ensure customer satisfaction. If you are not satisfied with your purchase, you may request a refund within 7 days of the transaction. Please contact our support team with your order details. Refunds will be processed according to our terms and conditions.
            </p>
            <ul className="list-disc pl-6 text-slate-500 dark:text-gray-400 mb-6">
              <li>Refund requests must be made within 7 days of purchase.</li>
              <li>Digital products are eligible for refund only if not downloaded or accessed.</li>
              <li>Service fees are non-refundable.</li>
              <li>Contact us at <a href="mailto:support@studxchange.in" className="text-blue-500">support@studxchange.in</a> for refund requests.</li>
            </ul>
          </div>
        </div>
      </div>

  ...
  return (
    <footer className="bg-accent text-white py-8">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="mt-4">
            <p>
                Contact: <a href="mailto:adiinamdar888@gmail.com" className="hover:text-secondary">adiinamdar888@gmail.com</a>
                <span className="mx-2">|</span>
                <a href="tel:8857053541" className="hover:text-secondary">8857053541</a>
            </p>
        </div>
      </div>
    </footer>

            ...
            <div className="relative group">
                ...
                <input
                    ...
                    className={`
                        ...
                        ${isSearchFocused 
                            ? 'border-emerald-400 bg-white shadow-lg ring-4 ring-emerald-100' 
                ...
                <button
                    ...
                    className={`
                        ...
                        ${searchQuery.trim() 
                            ? 'bg-gradient-to-r from-slate-800 via-slate-700 to-emerald-600 text-white hover:shadow-md hover:scale-105 active:scale-95' 
        ...
        <>
            <header className="bg-white shadow-md sticky top-0 z-40">
                <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <Link href={user ? "/home" : "/"} className="flex items-center hover:scale-105 transition-transform duration-300 group">
                        <div className="flex flex-col">
                            {/* StudXchange as One Word with Footer Gradient */}
                            <div className="flex items-baseline">
                                <span className="text-3xl font-black bg-gradient-to-r from-slate-800 via-slate-700 to-emerald-600 bg-clip-text text-transparent tracking-tight">
                                    StudXchange
                                </span>
                            </div>
                            ...
                            <div className="flex items-center space-x-2 mt-1">
                                <p className="text-xs text-gray-600 group-hover:text-emerald-600 transition-colors duration-300 font-medium">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        {user ? (
                            <>
                                ...
                                <Link href="/wishlist" className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors relative">
                                ...
                                <div className="space-y-3">
                                    {user ? (
                                        ...
                                        <>
                                            <Link 
                                                href="/login" 
                                                className="block w-full p-3 text-center rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors"
                                                onClick={() => setIsMenuOpen(false)}
                                            >
                                                Login
                                            </Link>

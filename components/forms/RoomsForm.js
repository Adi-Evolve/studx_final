        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="hostel_name" id="hostel_name" required value={formData.hostel_name} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                </div>
                <div>
                    <label htmlFor="college">Nearest College</label>
                    <select name="college" id="college" required value={formData.college} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div>
                    ...
                    <select name="room_type" id="room_type" required value={formData.room_type} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div>
                    ...
                    <div className="flex">
                        <input type="number" name="fees" id="fees" required value={formData.fees} onChange={handleChange} className="mt-1 block w-full rounded-l-md border-gray-300 shadow-sm" />
                        <select name="fees_period" value={formData.fees_period} onChange={handleChange} className="mt-1 block rounded-r-md border-gray-300 border-l-0 shadow-sm bg-gray-50">
                ...
                <div>
                    ...
                    <input type="number" name="deposit" id="deposit" required value={formData.deposit} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                </div>
                <div>
                    <label htmlFor="distance">Distance from College</label>
                    <input type="text" name="distance" id="distance" placeholder="e.g., 500m, 1km" value={formData.distance} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                </div>
                <div>
                    <label htmlFor="occupancy">Occupancy</label>
                    <input type="text" name="occupancy" id="occupancy" placeholder="e.g., Single, 2 people" value={formData.occupancy} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                </div>
            </div>

            <div>
                <div className="flex items-center">
                    <input type="checkbox" name="mess_included" id="mess_included" checked={formData.mess_included} onChange={handleChange} className="h-4 w-4 text-blue-600 border-gray-300 rounded" />
                ...
                {!formData.mess_included && (
                    <div className="mt-4">
                        ...
                        <input type="number" name="mess_fees" id="mess_fees" value={formData.mess_fees} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                    </div>
                )}
            </div>
                ...
                <div className="mt-2 grid grid-cols-2 md:grid-cols-4 gap-4">
                    {amenitiesList.map(amenity => (
                        <div key={amenity} className="flex items-center">
                            <input type="checkbox" id={amenity} name="amenities" value={amenity} checked={formData.amenities.includes(amenity)} onChange={handleChange} className="h-4 w-4 text-blue-600 border-gray-300 rounded" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="owner_name" id="owner_name" required value={formData.owner_name} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                </div>
                <div>
                    <label htmlFor="contact_primary">Contact Number</label>
                    <input type="tel" name="contact_primary" id="contact_primary" required value={formData.contact_primary} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                </div>
                <div>
                    <label htmlFor="contact_secondary">Secondary Contact (Optional)</label>
                    <input type="tel" name="contact_secondary" id="contact_secondary" value={formData.contact_secondary} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" value={formData.description} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></textarea>
            </div>

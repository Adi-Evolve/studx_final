...
export default function CategoryCard({ href, icon, title, className = "" }) {
  ...
  return (
    <Link href={href} className="group" onClick={handleClick}>
      <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl dark:hover:shadow-gray-700 transition-all duration-300 transform hover:scale-105 p-4 md:p-6 text-center border dark:border-gray-700 ${className}`}>

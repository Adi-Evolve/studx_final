...
import { getCurrentLocation } from './enhancedLocationService';
...
/**
 * Get user's current location using enhanced Google Maps service
...
export const getUserLocation = async () => {
    try {
        ...
        console.warn('[locationUtils] Enhanced location failed, using fallback:', error);
        
        // Fallback to basic browser geolocation
